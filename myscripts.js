...
let beerList = [
    ...
    /*4*/{brewery: "The Establishment",beername: "My Best Friend's Girl",beertype: "Kolsc-Style Ale"},
    /*5*/{brewery: "Eighty Eight Brewing",beername: "Good Morning",beertype: "Vietnamese Coffee Stout"},
    /*6*/{brewery: "brewery",beername: "name",beertype: "type"},
    /*7*/{brewery: "brewery",beername: "name",beertype: "type"},
    /*8*/{brewery: "brewery",beername: "name",beertype: "type"},
    /*9*/{brewery: "Situation Brewing",beername: "Afternoon Tea Saison",beertype: "Saison"},
    /*10*/{brewery: "brewery",beername: "name",beertype: "type"},
    /*11*/{brewery: "brewery",beername: "name",beertype: "type"},
    /*12*/{brewery: "brewery",beername: "name",beertype: "type"},
